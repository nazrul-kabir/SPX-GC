...
module.exports = {
      ...
      GetDataFiles: async function (req, res) {
        // Get files
      ...
      initRemCntrRenderer: async function (req, res) {
      ...
      openFileFolder: async function (req, res) {
      ...
      licBasic: async function (req, res) {
      ...
      rotBasic: async function (req, res) {
      ...
      loggerGet: async function (req, res) {
      ...
      loggerPost: async function (req, res) {
      ...
      browseFiles: async function (req, res) {
      ...
      readExcelData: async function (req, res) {
      ...
      saverundownfile: async function (req, res) {
        // Added in 1.3.0
